...
module.exports = (function(){
    return {
        ...
        request_access: function(req, res){
            ...
            var array = req.params.request.split("-");
        ...
        decrypt_record_access: function(req, res){

            var array = req.params.data.split("-");

            var id = array[0];
            var org_pub = array[1];
            var org_priv = array[2];
            var user_pub = array[3];
            
            console.log('Decrypting record...'+ id + user_pub);
            ...
            const request = {
                chaincodeId: 'peoplechain',
                txId: tx_id,
                fcn: 'decryptRecordAccess',
                args: [id, org_pub, org_priv, user_pub],
            };
